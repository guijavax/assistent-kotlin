...
--
-- TOC entry 198 (class 1259 OID 32768)
...
--
-- TOC entry 199 (class 1259 OID 32774)
...
COPY public.client (id_client, name, cpf, age, zip_code, street, district, city, state, country, telephone, number) FROM stdin;
3	Guilherme	12345667	23	456789	Rua Jorge serafim	Bahamas	Umuarama	Pr	Brasil	345678965	345
4	Maria Aparecida	4567893	31	345069	Rua Maria Souza	Umuarama	Londrina	Pr	Brasil	993345678	567
6	Marcela Melo	878569345	34	389405	Rua das Oliveiras	Bascra	Toronto	Ot	Canadá	934567892	445
\.
...
SELECT pg_catalog.setval('public.seq_id_client', 6, true);
